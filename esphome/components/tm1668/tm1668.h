...
class TM1668Component;

using tm1668_writer_t = std::function<void(TM1668Component &)>;

class TM1668Component : public PollingComponent {
 public:
  void set_writer(tm1668_writer_t &&writer) { this->writer_ = writer; }
  void setup() override;
 ...
 protected:
  ...
  optional<tm1668_writer_t> writer_{};
