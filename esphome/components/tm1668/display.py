...
CONF_TM1668_ID = "tm1668_id"

tm1668_ns = cg.esphome_ns.namespace("tm1668")
TM1668Component = tm1668_ns.class_("TM1668Component", cg.PollingComponent)
TM1668ComponentRef = TM1668Component.operator("ref")


CONFIG_SCHEMA = display.BASIC_DISPLAY_SCHEMA.extend(
    {
        cv.GenerateID(): cv.declare_id(TM1668Component),
...
async def to_code(config):
    ...
    if CONF_LAMBDA in config:
        lambda_ = await cg.process_lambda(
            config[CONF_LAMBDA], [(TM1668ComponentRef, "it")], return_type=cg.void
        )
